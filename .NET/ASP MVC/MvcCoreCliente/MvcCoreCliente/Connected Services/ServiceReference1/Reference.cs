...
namespace ServiceReferenceCoches
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Coche", Namespace="http://schemas.datacontract.org/2004/07/WCFLogicaCoches.Models")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReferenceCoches.ICochesContract")]
    public interface ICochesContract
    {
        ...
        System.Threading.Tasks.Task<ServiceReferenceCoches.Coche[]> GetCochesAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICochesContract/GetCoche", ReplyAction="http://tempuri.org/ICochesContract/GetCocheResponse")]
        System.Threading.Tasks.Task<ServiceReferenceCoches.Coche> GetCocheAsync(int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public interface ICochesContractChannel : ServiceReferenceCoches.ICochesContract, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public partial class CochesContractClient : System.ServiceModel.ClientBase<ServiceReferenceCoches.ICochesContract>, ServiceReferenceCoches.ICochesContract
    {
        ...
        public System.Threading.Tasks.Task<ServiceReferenceCoches.Coche[]> GetCochesAsync()
        {
            return base.Channel.GetCochesAsync();
        }
        
        public System.Threading.Tasks.Task<ServiceReferenceCoches.Coche> GetCocheAsync(int id)
        {
            return base.Channel.GetCocheAsync(id);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ICochesContract))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:50820/ServiceWCFCoches.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
