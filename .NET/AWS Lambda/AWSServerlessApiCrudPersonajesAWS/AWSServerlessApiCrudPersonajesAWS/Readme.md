...
Execute unit tests
```
    cd "AWSServerlessApiCrudPersonajesAWS/test/AWSServerlessApiCrudPersonajesAWS.Tests"
    dotnet test
```

Deploy application
```
    cd "AWSServerlessApiCrudPersonajesAWS/src/AWSServerlessApiCrudPersonajesAWS"
